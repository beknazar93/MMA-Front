...
//     [
//       formFieldConfig.find(f => f.name === "check_field"),
//       { name: "typeClient", type: "select", placeholder: "Тип клиента", options: ["Обычный", "Пришли на пробное", "Ожидаются", "Подумают", "Индивидуальный", "Абонемент"], required: true }
//     ],
//     [
//       formFieldConfig.find(f => f.name === "comment"),
//       formFieldConfig.find(f => f.name === "stage")
...
//     );
//     if (duplicate) {
//       alert(`Клиент с именем "${duplicate.name}" и телефоном "${duplicate.phone}" уже существует в базе.`);
//       return true;
//     }
//     return false;
//   };
