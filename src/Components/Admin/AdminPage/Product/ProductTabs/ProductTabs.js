...
const ProductTabs = () => {
  ...
  const managerName = localStorage.getItem("manager_name") || "Неизвестный менеджер";
  ...
  return (
    <div className="product-tabs">
      <div className="product-tabs__header">
        ...
        <button
          className="product-tabs__logout-btn"
      ...
      <div className="product-tabs__nav">
        <button
          className={`product-tabs__nav-item ${
            activeTab === "list" ? "product-tabs__nav-item--active" : ""
          }`}
        ...
        <button
          className={`product-tabs__nav-item ${
            activeTab === "add" ? "product-tabs__nav-item--active" : ""
          }`}
        ...
        <button
          className={`product-tabs__nav-item ${
            activeTab === "sell" ? "product-tabs__nav-item--active" : ""
          }`}
        ...
        <button
          className={`product-tabs__nav-item ${
            activeTab === "sold" ? "product-tabs__nav-item--active" : ""
          }`}
