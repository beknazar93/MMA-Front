  ...
  return (
    <div className="sold-products">
      ...
      <div className="sold-products__content">
        {loading ? (
          <div className="sold-products__loader">Загрузка...</div>
        ) : soldProducts.length > 0 ? (
          <div className="sold-products__table-wrapper">
              ...
              <tbody>
                {soldProducts.map((product) => (
                  <tr className="sold-products__table-row" key={product.id}>
                    ...
                    <td>{calculateDiscountedPrice(product.price_selling, product.sale)}</td>
