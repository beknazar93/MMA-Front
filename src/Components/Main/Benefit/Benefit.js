    ...
    <div className='benefit'>
      ...
      <div className="container">
        ...
        <div className="benefit__form">
          <img className='benefit__form-photo' src={pol} alt="Польза спорта" />
          <p className='benefit__form-text'>
            ...
            Люди, которые не пренебрегают занятиями спортом, меньше болеют, поскольку их иммунитет более эффективно борется с вирусами и возбудителями различных заболеваний, редко страдают избыточным весом и лучше справляются со стрессами и житейскими проблемами.
            <br /><br />
            Во время занятий спортом в организме человека происходит выработка эндорфинов, что положительно влияет на сердечно-сосудистую и нервную системы.
            <br /><br />
